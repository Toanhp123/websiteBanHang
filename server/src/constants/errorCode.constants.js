module.exports = {
	AccountStatus: {
		...
		ERROR_UPDATE_PASSWORD: "CAN'T UPDATE PASSWORD",
		ERROR_UPDATE_STATUS: "CAN'T UPDATE ACCOUNT STATUS",
	},
	ProfileStatus: {
	...
	BillError: {
		ERROR_CREATE: "CAN'T CREATE INVOICE",
		ERROR_ID: "CAN'T FIND INVOICE ID",
		ERROR_DELETE: "CAN'T DELETE INVOICE",
		ERROR_ADD_ADDRESS: "CAN'T ADD INVOICE ADDRESS",
		ERROR_DELETE_ADDRESS: "CAN'T DELETE INVOICE ADDRESS",
		ERROR_UPDATE_STATUS: "CAN'T UPDATE STATUS INVOICE",
	},
	WarehouseError: {
